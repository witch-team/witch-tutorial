...
4.  Open RStudio, set the working directory in the witch folder, and run input/translate_witch_data
...
-   Check the difference of what is staged but not yet commited: `git diff --staged`
...
-   Commit a change into a WITCH branch

From the zeus repository directory, add the edited files in the remote one `git add modules/[edited_file_name]`
